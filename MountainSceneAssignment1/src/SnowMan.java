...
public class SnowMan {
	...
	private void hatSnow() {
		...
		Rectangle hat = new Rectangle(x - (int) (5.4 * hatRadius), y - (int) (0.9 * hatRadius), (int) (4 * hatRadius),
				(int) (0.4 * hatRadius), Color.BLACK, true);
		Rectangle hatAccesory1 = new Rectangle(this.x - (int) (4.4 * hatRadius), this.y - (int) (3.8 * hatRadius),
				(int) (2 * hatRadius), (int) (3.2 * hatRadius), Color.BLACK, true);
		Rectangle hatAccesory2 = new Rectangle(this.x - (int) (4.4 * hatRadius), this.y - (int) (2 * hatRadius),
	...
	private void bodySnow() {
		...
		Oval head = new Oval(x - (int) (3 * headSnowRadius), y + (int) -(0.5 * headSnowRadius), 2 * headSnowRadius, 2 * headSnowRadius, Color.WHITE,
				true);
		window.add(head);
		Oval bodySnow = new Oval(x - 4 * headSnowRadius, (int) (y + 1.3 * headSnowRadius), 4 * headSnowRadius, 4 * headSnowRadius, Color.WHITE, true);
		window.add(bodySnow);
	}
	...
	private void snowArms() {
		...
		Line snowRight = new Line(x - (int) (2 * rightRadius), y + (int) (5 * rightRadius), x + (int) (6 * rightRadius),
				y + (int) (5 * rightRadius));
		Line rightFinger = new Line(x + (int) (4.6 * rightRadius), y + (int) (5 * rightRadius),
				x + (int) (2.6 * rightRadius), y + (int) (3 * rightRadius));
		Line rightBottomFinger = new Line(x + (int) (4 * rightRadius), y + (int) (5 * rightRadius),
		...
		Line snowLeft = new Line(x - (int) (2 * rightRadius), y + (int) (5 * rightRadius), x + (int) (6 * rightRadius),
				y + (int) (5 * rightRadius));
		snowLeft.moveBy(-(int) (13.8 * rightRadius), 0);
		Line leftFinger = new Line(x + (int) (4 * rightRadius), y + (int) (5 * rightRadius),
				x + (int) (6 * rightRadius), y + (int) (3 * rightRadius));
		Line leftBottomFinger = new Line(x + (int) (4 * rightRadius), y + (int) (5 * rightRadius),
